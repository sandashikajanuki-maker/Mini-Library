                    ...
                    <tr class="align-middle">
                        ...
                        <td class="px-3 text-end">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="send_reminder.php?id=<?php echo $book['id']; ?>" class="btn btn-sm shadow-none" title="Send Email Reminder" style="background-color: #E0F2FE; color: #0369A1;">
                                    <i class="bi bi-envelope"></i>
                                </a>

                                <a href="clear_overdue.php?id=<?php echo $book['id']; ?>" class="btn btn-sm shadow-none" title="Clear Status" style="background-color: #DCFCE7; color: #166534;" onclick="return confirm('Clear overdue status for this book?')">
                                    <i class="bi bi-check2-circle"></i>
                                </a>

                                <button class="btn btn-sm shadow-none" style="background-color: #F1F5F9; color: #475569;">
                                    <i class="bi bi-eye"></i>
                                </button>
                            </div>
                        </td>

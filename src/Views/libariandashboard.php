...
<body>
    ...
    <main class="main-content" style="margin-left: var(--sidebar-width); transition: 0.3s ease;">
        <div class="container-fluid p-4">
            
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="fw-bold mb-0" style="color: var(--main-dark);">Welcome! Admin</h3>
            ...
            <div class="card border-0 shadow-sm p-4" style="border-radius: 12px; background-color: #fff;">
                ...
                <ul class="nav nav-tabs border-0 mb-2" id="quickActionTabs" role="tablist" style="border-bottom: 1px solid #E2E8F0 !important;">
                    ...
                    <li class="nav-item"><button class="nav-link custom-tab" data-bs-toggle="tab" data-bs-target="#issuebook" type="button">Issue Book</button></li>
                ...
                <div class="tab-content pt-3" id="quickActionContent">
                    ...
                    <div class="tab-pane fade" id="issuebook" role="tabpanel"><?php include '../Includes/issuebook.php'; ?></div>

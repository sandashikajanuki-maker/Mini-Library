                ...
                <form name="loginform" action="../Controllers/LoginController.php" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg fs-6"
                            ...
                            oninput="username_validation()" onblur="username_validation()"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" class="form-control form-control-lg fs-6"
                            ...
                            oninput="password_validation()" onblur="password_validation()"
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="d-grid">
                                <a href="register.php" class="btn btn-outline-primary btn-lg fs-6">
                                    Sign Up
                                </a>
                            </div>
                        </div>
